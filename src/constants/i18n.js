        ...
        resources: {
            ...
            es: {
                translations: {
                    ...
                    "signInDisabled": "Verifica tu email para iniciar sesión",
                    ...
                    "emptyMyCooklist": "Tu lista de recetas está vacia, ¡Explora recetas en el Inicio para agregarlas aquí!",
                    "emptyCooklist": "Esta lista de recetas está vacía",
                    "emptyRecipes": "¡{{0}} no subió ninguna receta todavía!",
                    "emptyMyRecipes": "No tiene ninguna receta, ¡Apriete el botón + para agregar su primer receta y verla aquí!",
                    "recipe.title": "Recetas de {{0}}",
                    "recipe.step": "Paso {{0}}",
                    "recipe.stepLeft": "Paso {{currentStep}} de {{totalSteps}}",
                    "recipe.stepPlaceholder": "Describe el paso número {{stepNumber}}",
                    ...
                    "myListsExplanation": "Aquí se encuentran las listas creadas con sus recetas y recetas de terceros",
                    "listsExplanation": "Aquí estan las listas creadas por {{0}}",
                    "myIngredientsExplanation": "Visualice y modifique sus ingredientes",
                    "myFavouriteRecipesExplanation": "Aquí se muestran las recetas que calificó con una calificación mayor o igual a 4 estrellas",
                    "noIngredients": "No tiene ningún ingrediente, ¡Apriete el botón + para agregar su primer ingrediente y verlo aquí!",
                    ...
                    "followers.login": "¡Debes estar registrado para ver tus seguidores!",
                    "following.login": "¡Debes estar registrado para ver a quién sigues!",
                    ...
                    "cooklist.deleteWarning": "¿Está seguro que desea eliminar {{cooklistName}} de sus listas de cocina?",
                    ...
                    "cooklist.name": "Inserte el nombre de su lista de cocina",
                    ...
                    "cooklist.removeRecipeWarning": "¿Está seguro que desea eliminar {{recipeName}} de su lista de cocina?",
                    "cooklist.addRecipe": "Agregar receta a lista de cocina",
                    "cooklist.addRecipe.empty": "No tiene ninguna lista de cocina que no posea esta receta, ¡Cree una nueva!",
                    "cooklist.selectedCooklistError": "Debe seleccionar una lista de cocina",
                    ...
                    "MyrecentlyCookedExplanation": "Recetas que cocinó recientemente",
